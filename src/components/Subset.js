...
export const fetchData = async (url) => {
  let response = await fetch(
    "https://mh-files.herokuapp.com/assets/skillmap.json"
  );
...
export const fetchArmor = async () => {
  let response = await fetch(
    "https://mh-files.herokuapp.com/assets/armormap.json"
  );
  let data = await response.json();
  return data;
};
...
export const fetchCharms = async () => {
  let response = await fetch(
    "https://mh-files.herokuapp.com/assets/charmmap.json"
  );
  let data = await response.json();
  return data;
};
...
export const fetchDecos = async () => {
  let response = await fetch(
    "https://mh-files.herokuapp.com/assets/decomap.json"
  );
  let data = await response.json();
  return data;
};
